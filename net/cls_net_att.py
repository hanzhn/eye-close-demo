...
class Model(object):
  ...
  def __call__(self, inputs, training):
    ...
    with self._model_variable_scope():
      # Tanspose has been done in preprocessing.
  ...
  def __call__(self, inputs, training):
    ...
    with self._model_variable_scope():
      ...
      with tf.variable_scope('attention'):
        channel_axes = 1 if self.data_format == 'channels_first' else 3
        h_w_axes = [2, 3] if self.data_format == 'channels_first' else [1, 2]
